...
\firstname{Andrew}
\familyname{Spott}
\title{Machine Learning and Data Science Leader}                                    % optional, remove the line if not wanted
...
\vspace{-.7cm}
\thispagestyle{empty}
With a doctorate in theoretical quantum physics foundation, I lead the development of machine learning and AI products, bringing the current AI revolution to customers.
...
\cvline{$\diamond$}{\textbf{Model Development}: I designed and developed our prototype gait biometric, the data

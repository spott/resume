...
\vspace{-.7cm}
\thispagestyle{empty}
Doctorate in theoretical quantum physics, expert in machine learning and data science, manager of data science teams at two firms, deep involvement in 
business strategy including product development.
...
\section{Experience}
\cventry{2021-}{Head of Data Science}{Submittable}{}{}{Submittable produces a software platform that helps thousands of organizations worldwide launch,
manage, and measure social impact programs, including grant management and proposal reviews.}
\cvline{$\diamond$}{I led the data science and auto-review efforts for the Working Washington Small Business Grant
Program: Round 4 and the Washington Covid-19 Immigrant Relief Fund projects. My team developed
custom data analytics to optimize the distribution of funds, directing money to social projects with the
most need according to the program goals. We also developed automatic review code which scored
grant proposals according to rubrics provided by program leaders, drawing on external data sources to
validate proposal claims.}

\cvline{$\diamond$}{I work with marketing and product development constructing larger enterprise deals, some of which
include data science and analytics services for our customers.}

\cvline{$\diamond$}{I lead our machine learning team developing data products within the Submittable platform. I serve as
both the engineering manager and product manager, leading the team in creating cutting-edge machine
learning and data driven products. I also lead our customer data analytics initiative that provides users
with windows of understanding into the projects they sponsor as part of the Submittable platform.}
\cvline{$\diamond$}{I built and led the partnership that created Accelerated Review, an AI product that reduces grant
proposal review workloads on large programs. Accelerated Review takes a sample of manual proposal
reviews and uses machine learning to build a model that can autonomously review the bulk of
proposals.}
...
\cvline{$\diamond$}{\textbf{Model Development}: I designed and developed our prototype gait biometric, designing the data
collection spec, developing the “walk/not-walk” model for what signals we would decide on, and
developing the initial model using pytorch and deep learning.}
\cvline{$\diamond$}{\textbf{Datascience Support Infrastructure}: I managed our data science compute cluster for my data science
team, which was used for all research compute needs and batch training for models in production. I also
wrote a large chunk of our internal deep learning library which leveraged LMDB to enable easy use of
out of memory data for training and ensure versioned models for reproducibility.}
\cvline{$\diamond$}{\textbf{Leadership}: I led a team of 2-4 data scientists in the development of two other biometrics, along with
the continued development of the gait biometric. This included technical advising, strategic planning
and management.}
